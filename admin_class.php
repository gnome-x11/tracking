...
class Action
{
      ...
      function save_visitor()
      {
            ...
            if ($save) {
                  ...
                  return json_encode(["status" => 1, "visitor_id" => $visitor_id, "email_sent" => $email_sent]);
            } else {
                  return json_encode(["status" => 0, "message" => "Failed to save visitor"]);
            }
      }
      ...
      function save_track()
      {
            ...
            if (empty($person_id) || empty($establishment_id)) {
                  return json_encode(["status" => 0, "message" => "Missing person_id or establishment_id"]);
            }
            ...
            if ($save) {
                  ...
                  return json_encode(["status" => 0, "message" => "Failed to save track"]);
            }
      }
